                ...
                <p id="propos-second">Ainsi qu'un rapport d'évaluation eLAO en Anglais professionnel.</p>
                    <Modal
                        ...
                        trigger={
                            ...
                            >
                                <Flip top>
                                <Button primary id="buttonWhy">eLAO ?</Button>
                                </Flip>
                            </motion.button>
                        }>
                            ...
                            <Modal.Actions>
                                <Button color='black' onClick={() => setOpenElao(false)}>Quitter</Button>
                                <Button labelPosition='right' icon='arrow right' onClick={() => setOpenElao(false)}>
